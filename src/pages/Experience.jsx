        ...
        <section className="timeline" aria-label="Timeline Pengalaman Kerja">
          <article className="timeline-element" tabIndex={0}>
            ...
            <p className="description">
              Membangun dan mengembangkan website profil sekolah, aplikasi internal madrasah, serta sistem manajemen informasi akademik. 
  ...
  <ul>
    ...
    <li>Mendokumentasikan rute farming paling efisien dan membagikannya kepada komunitas pemain melalui forum dan grup Discord.</li>
          ...
          <article className="timeline-element" tabIndex={0}>
            ...
            <p className="description">
              Mengelola produksi sampul ijazah untuk SD, SMP, dan SMA/SMK: 
              mulai dari memotong bahan, mencetak nama & logo sekolah, hingga pengepakan sampul siap kirim.
            </p>
            <ul className="details-list">
              <li>Memotong dan mengukur bahan dasar (karton, kain, kertas) sesuai ukuran ijazah</li>
              <li>Mengoperasikan mesin emboss untuk cetak nama sekolah dan logo</li>
              ...
              <li>Memeriksa kualitas setiap sampul: memastikan tidak ada cacat cetak atau lipatan yang salah</li>
              <li>Mengepak sampul jadi, menata dalam kardus sesuai jumlah, siap dikirim ke instansi</li>
              <li>Bekerja sesuai standar keselamatan kerja: menggunakan APD, menjaga kebersihan area, dan memeriksa kondisi mesin secara rutin</li>
            </ul>
          </article>
          ...
          <article className="timeline-element" tabIndex={0}>
            ...
            <ul className="details-list">
              ...
              <li>Memantau pesanan masuk, mencetak resi, dan koordinasi dengan kurir untuk pengiriman</li>
              ...
              <li>Menangani pertanyaan & keluhan pelanggan melalui chat di platform, memberikan info produk dan solusi cepat</li>
              <li>Bekerja sama dengan tim gudang untuk memastikan ketersediaan barang dan menjaga persediaan optimal</li>
            </ul>
          </article>
        </section>
      </main>
